		...
		<div id="container">
			...
			<ul id="page4">
				<li id="add-pic-method-choose">
					...
					<div class="right">
						<div id="add-pic-method">
							<div class="add-pic-method-each">
								<div class="click-box-round clickbox click"></div>
								<div>本地上传</div>
							</div>
							<div class="add-pic-method-each">
								<div class="click-box-round clickbox"></div>
								<div>网络上传</div>
							</div>
						</div>
					</div>
				</li>
				<li class="alert" id="add-pic-local">
					<div class="add-pic-wrap">
						<div  class="add-pic-button pointer">
							浏览文件
						...
						<input type="text" class="add-pic-url" disabled="disabled"/>
						<div class="pic-show">
				...
				<li class="alert" id="add-pic-net">
					<div class="add-pic-wrap">
						<div  class="add-pic-button pointer" id="add-pic-net-intro">
							网址链接
						</div>
						<input type="text" class="add-pic-url" />
						<div class="show" id="add-pic-show">
							http://localhost:8090/img/picture.png
						</div>
						<div class="add-pic-confirm pointer check">
						</div>
						<div class="pic-show">
